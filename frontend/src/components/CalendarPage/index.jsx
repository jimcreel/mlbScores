...
export default function CalendarPage(props){
    ...
    useEffect(() => {
        ...
        for (let i = -3; i < 4; i++) {
            ...
            currentDate.setDate(currentDate.getDate() + i + weekOffset)
    ...
    return (
        ...
        {calendarDiv}
        <div onClick={() => handleArrowClick('right')} className="flex flex-col align-center text-center rounded border w-[50px] cursor-pointer hover:shadow-lg">
            <p>{rightArrow}</p>
        </div>
        </div>
    )
